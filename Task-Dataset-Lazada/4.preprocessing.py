...
# Input  : output\Lazada\3.dataset_labeling.csv
# Output : output\Lazada\4.dataset_preprocessing.csv
#          output\Lazada\4.laporan_preprocessing.txt
...
INPUT_PATH = os.path.join(ROOT_DIR, "output", "Lazada", "3.dataset_labeling.csv")
OUTPUT_DIR = os.path.join(ROOT_DIR, "output", "Lazada")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# LOAD DATA
print("  PREPROCESSING DATASET LAZADA INDONESIAN REVIEWS")
print("=" * 50)
...
with open(output_txt, 'w', encoding='utf-8') as f:
    f.write("LAPORAN PREPROCESSING DATASET LAZADA INDONESIAN REVIEWS\n")
    f.write("=" * 55 + "\n\n")
...
print("  Output: output\\Lazada\\4.dataset_preprocessing.csv")
print("  Output: output\\Lazada\\4.laporan_preprocessing.txt")

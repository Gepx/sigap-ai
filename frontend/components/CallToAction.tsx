  ...
  return (
    <section className="bg-transparent px-5 py-24 sm:px-8 lg:px-10 mt-10">
      <div className="mx-auto max-w-7xl">
        <div className="relative rounded-[2.5rem] bg-[#1A2E26] sm:rounded-[3rem]">
          ...
          <div className="relative z-10 grid items-center md:grid-cols-[1.3fr_0.7fr]">
            {/* Text Content */}
            <div className="flex flex-col items-start px-8 py-12 sm:px-16 md:py-16 md:pl-16 lg:py-20 lg:pl-20">
            ...
            <div className="relative flex w-full justify-center md:block h-full">
              ...
              <div className="hidden md:block absolute bottom-0 right-0 h-[115%] w-[130%] lg:h-[125%] lg:w-[150%] xl:h-[130%] xl:w-[160%]">
                <Image
              ...
              {/* Mobile Image (inline) */}
              <div className="relative mt-2 h-64 w-full sm:h-80 md:hidden">
                <Image
                  src="/assets/cta_man_smiling_transparent.png"
                  alt="Professional using Sigap.ai"
                  fill

...
# Output : output\GoogleMaps\5.validasi_kpi.csv
#          output\GoogleMaps\5.laporan_validasi_kpi.txt
...
# LOAD DATA
print("  VALIDASI KPI DATASET GOOGLE MAPS REVIEWS")
print("=" * 45)
...
with open(laporan_path, 'w', encoding='utf-8') as f:
    f.write("LAPORAN VALIDASI KPI DATASET GOOGLE MAPS REVIEWS\n")
    f.write("=" * 50 + "\n\n")

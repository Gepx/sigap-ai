...
# Input  : output\GoogleMaps\2.dataset_cleaning.csv
# Output : output\GoogleMaps\3.dataset_labeling.csv
#          output\GoogleMaps\3.laporan_labeling.txt
...
INPUT_PATH = os.path.join(ROOT_DIR, "output", "GoogleMaps", "2.dataset_cleaning.csv")
OUTPUT_DIR = os.path.join(ROOT_DIR, "output", "GoogleMaps")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# LOAD DATA
print("  LABELING DATASET GOOGLE MAPS REVIEWS")
print("=" * 45)
...
# LABEL 2 : Review_Date
print("\n[2] Review_Date -> dari tanggal relatif Google Maps")
...
print("\n[4] Platform_Source -> diisi dengan 'Google Maps'")
df['Platform_Source'] = 'Google Maps'
print("Selesai")
...
print("\n[8] Business_Category -> kategori utama Google Maps restoran/UMKM kuliner")
...
with open(laporan_path, 'w', encoding='utf-8') as f:
    f.write("LAPORAN LABELING DATASET GOOGLE MAPS REVIEWS\n")
    f.write("=" * 45 + "\n")
...
print("  Output disimpan di     : output\\GoogleMaps\\3.dataset_labeling.csv")
print("  Laporan disimpan di    : output\\GoogleMaps\\3.laporan_labeling.txt")
